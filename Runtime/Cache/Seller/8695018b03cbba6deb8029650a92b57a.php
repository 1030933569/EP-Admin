...
<head>
  ...
  <link href="/assets/css/ep/eaterplanet.css?v=2.2.0" rel="stylesheet" type="text/css">
</head>
<body>
<div id="LAY_app">
  <div class="page-wrapper">
    ...
    <div class="right-sidebar" id="right_side_bar">
      <div class="container p-0" style="z-index: 30001">
        ...
        <div class="card-body">
          <div class="btn btn-light m-b-10" href="#">当前版本：EP Admin 吃货星球v5.6.0</div>
          <div class="btn btn-light">UI框架：DT Admin Dashboard-v0.1.3</div>
        </div>
        <div class="modal-header p-20">
          <div class="col-sm-8 p-0">
        ...
        <div class="card-body btn-showcase">
          ...
          <div class="pt-btn">
            <a class="btn btn-primary" href="https://github.com/eaterplanet/EP-Admin">Git项目仓库</a>
          </div>
          <div class="pt-btn">
        ...
        <div class="p-20">
          <div class="users-list-w">
            <div>
              <h6>
                吃货星球©商城微信小程序、商城后台管理系统，受国家计算机软件著作权保护，必须联系作者授权才可获得源文件使用权。不得恶意分享产品源代码、二次转售等，违者将承担相应的法律责任。</h6>
            </div>
            <img align="left" src="https://image.ch871.com/rexotech.png" style="width:40px;margin:0px 10px 0px 0px;color:#ccd9e8 " width="40px"> Copyright © 2023 Dejavu Technology (YN) Co., Ltd.
            <a class="btn btn-primary m-t-10" href="https://www.rexotech.cn">rexotech.cn</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="main-header-right" style="height: 75px;">
        ...
        <div class="mobile-sidebar">
          <div class="media-body text-right switch-sm">
            <label class="switch ml-3"><i class="font-primary" data-feather="align-center" id="sidebar-toggle"></i></label>
          </div>
        </div>
        ...
        <div class="nav-right col pull-right right-menu">
          <ul class="nav-menus">
            ...
            <li class="onhover-dropdown"><img alt="" class="img-fluid img-shadow-warning" src="/assets/images/color-picker.png">
              <ul class="onhover-show-div notification-dropdown">
                <li class="gradient-primary p-b-0">
                  <h5>版面颜色</h5>
                </li>
                <li>
                  <div aria-labelledby="c-pills-profile-tab" class="tab-pane fade active show" id="c-pills-profile" role="tabpanel">
            ...
            <li class="onhover-dropdown"><img alt="" class="img-fluid img-shadow-warning" src="/assets/images/customize.png">
              <ul class="onhover-show-div notification-dropdown">
                <li class="gradient-primary p-b-0">
                  <h5>样式选择</h5>
                </li>
                <li>
                  <div aria-labelledby="c-pills-home-tab" class="tab-pane fade active show " id="c-pills-home" role="tabpanel">
                    <ul class="main-layout layout-grid eplayout">
                      ...
                      <li class="box-layout" data-attr="ltr" style="padding: 0!important;margin-top: 17px">
                        <div class="header bg-light"></div>
                        <div class="eplayout-body">
                          <div class="bg-light eplayout-sidebar"></div>
                          <div class="eplayout-sidebody">
            ...
            <li class="onhover-dropdown" id="neworder1"><img alt="" class="img-fluid img-shadow-warning" src="/assets/images/dashboard/chat.png">
              <ul class="onhover-show-div notification-dropdown">
                <li class="gradient-primary">
                  <h5 class="f-w-700">订单消息</h5><span>您有<span><?php echo ($order_count); ?></span>个新的订单</span>
                </li>
                <li>
                  <div class="media">
                    <div class="notification-icons bg-success mr-3"><i class="mt-0" data-feather="thumbs-up"></i></div>
                    <a data-href="<?php echo U('order/index');?>" href="javascript:void(0)">
            ...
            <li class="onhover-dropdown" id="orderdistribution1"><img alt="" class="img-fluid img-shadow-warning" src="/assets/images/dashboard/notification.png">
              <ul class="onhover-show-div notification-dropdown">
                <li class="gradient-primary">
                  <h5 class="f-w-700">配送员消息</h5><span>您有新的配送信息</span>
                </li>
                <li>
                  <div class="media">
                    <div class="notification-icons bg-success mr-3"><i class="mt-0" data-feather="thumbs-up"></i></div>
            ...
            <li><a class="right_side_toggle" href="#"><img alt="" class="img-fluid img-shadow-success" src="/assets/images/dashboard/like.png"></a></li>
            <li class="onhover-dropdown"><span class="media user-header"><img alt="" class="img-fluid" src="/assets/images/dashboard/user.png"></span>
              <ul class="onhover-show-div profile-dropdown">
                <li class="gradient-primary">
                  <h5 class="f-w-600 mb-0">
                      <?php if (defined('ROLE') && ROLE == 'agenter') { $agent_auth = session('agent_auth'); echo $agent_auth['shopname']; } else { echo D('Home/Front')->get_config_by_name('shoname'); } echo($_GPC['s_uname']); ?>
                  </h5>
                </li>
                <li>
                  <div class="media">
    ...
    <div class="page-body-wrapper">
      <div class="iconsidebar-menu">
        <div class="sidebar">
          <ul class="iconMenu-bar custom-scrollbar" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu" lay-shrink="all">
              <?php $sysmenus = D('Seller/menu')->getMenu(true); ?>
              <?php
 $i = 0; foreach ($sysmenus['menu'] as $key => $menu) { ?>
                <li class="wb-nav layui-nav-item <?php if ($i == 0) { ?>layui-nav-itemed<?php } ?>" id="sdsd" pinyin="<?php echo $key; ?>">
                  <a class="bar-icons" href="javascript:" <?php if (empty($menu['route'])){ ?>lay-href="<?php echo U($menu['route']);?>"<?php } ?>
                     lay-tips="<?php echo ($menu['text']); ?>" lay-direction="2"> <i class="icofont icofont-<?php echo ($menu['icon']); ?>"></i>
                    <h6><span><?php echo ($menu['text']); ?></span></h6>
                  </a>
                  <ul class="iconbar-mainmenu custom-scrollbar">
                      <?php if (!empty($menu['items'])) { foreach ($menu['items'] as $sub_menu) { ?>
                        <li class="iconbar-header sub-header active" data-name="<?php echo ($sub_menu['title']); ?>">
                          ...
                          <li class="third-menu active" style="cursor: pointer;">
                              <?php foreach ($sub_menu['items'] as $third_sub_menu) { ?>
                                <ul data-name="list"><a lay-href="<?php echo U($third_sub_menu['route']);?>"><?php echo ($third_sub_menu['title']); ?></a>
                                </ul>
                              <?php } ?>
                          </li>
                          <?php } } } ?>
      ...
      <!--左侧导航区域end--->
      <div aria-hidden="true" class="welcome-popup modal fade" id="loadModal" role="dialog" tabindex="-1">
            ...
            <div class="modal-body">
              ...
              <div class="contain p-30">
                <div class="text-center">
                  ...
                  <p>吃货星球v5.6.0</p>
                  <button aria-label="Close" class="btn btn-primary btn-lg txt-white" data-dismiss="modal" type="button">开始
                  </button>
                </div>
              </div>
            </div>
      ...
      <div class="page-body custom-scrollbar" id="LAY_app_body">
          <?php if (empty($perm_url) || $perm_url == '/') { ?>
            <iframe class="layadmin-iframe" frameborder="0" src="<?php echo U('index/analys', array('ok' => 1)); ?>"></iframe>
          <?php } else { ?>
            <iframe class="layadmin-iframe" frameborder="0" src="<?php echo U($perm_url, array('ok' => 1)); ?>"></iframe>
          <?php } ?>
      </div>
      <!--内容体end-->
    </div>
...
<div class="col-xs-11 col-sm-4 alert alert-theme notify-alert animated fadeInDown" data-notify="container" data-notify-position="top-right" id="neworder" role="alert"
     style="display:none; margin: 0px auto; position: fixed; transition: all 0.5s ease-in-out 0s; z-index: 1031; top: 20px; right: 20px;">
  <button aria-hidden="true" class="close" data-notify="dismiss" style="position: absolute; right: 10px; top: 5px; z-index: 1033;" type="button">
    ×
  </button>
  <a data-href="<?php echo U('order/index');?>" href="javascript:void(0)"> <span class="0" data-notify="icon"></span> <span data-notify="title"></span>
    <span data-notify="message" id="notice"><img alt="" src="/assets/images/alert.png"><strong>您有新订单</strong><?php echo ($order_count); ?>条</span> </a>
</div>
<div class="col-xs-11 col-sm-4 alert alert-theme notify-alert animated fadeInDown" data-notify="container" data-notify-position="top-right" id="orderdistribution" role="alert"
     style="display:none; margin: 0px auto; position: fixed; transition: all 0.5s ease-in-out 0s; z-index: 1031; top: 20px; right: 20px;">
  <button aria-hidden="true" class="close" data-notify="dismiss" style="position: absolute; right: 10px; top: 5px; z-index: 1033;" type="button">
    ×
  </button>
  <a href="javascript:void(0)"> <span class="0" data-notify="icon"></span> <span data-notify="title"></span> <span data-notify="message" id="distributionnotice"><img alt="" src="/assets/images/alert.png"><strong>您有配送员消息</strong><?php echo ($order_count); ?>条</span>
  </a>
</div>
<!-- latest jquery-->
...
<script defer="defer" src="/assets/js/diy/vue.min.js" type="text/javascript"></script>
<script>
    layui.config({
...
<audio id="musicClick" preload="auto" src="/assets/ep/mp3/click.mp3"></audio>
<script>
    $(function () {
