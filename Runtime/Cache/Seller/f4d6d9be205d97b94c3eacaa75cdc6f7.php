...
<head>
  ...
  <!-- Plugins css start-->
  <link href="/assets/css/simple-line-icon.css" rel="stylesheet" type="text/css">
  <link href="/assets/css/chartist.css" rel="stylesheet" type="text/css">
  <link href="/assets/css/owlcarousel.css" rel="stylesheet" type="text/css">
  <link href="/assets/css/tour.css" rel="stylesheet" type="text/css">
  <link href="/assets/css/chartist.css" rel="stylesheet" type="text/css">
  ...
  <link href="/assets/css/ionic-icon.css" rel="stylesheet" type="text/css">
  <!-- Plugins css Ends-->
  <!-- Bootstrap css-->
  ...
  <div class="page-body-wrapper">
    <div class="page-body" style="margin: 0;min-height: calc(100vh - 55px);">
      ...
      <div class="container-fluid general-widget">
        <div class="row">
            <?php if (!defined('ROLE') || ROLE != 'agenter') { if (D('Seller/Menu')->check_seller_perm('user/index')) { ?>
                    ...
                    <div class="media static-top-widget">
                      ...
                      <a href="<?php echo U('user/index'); ?>">
                        <div class="media-body">
                          <span class="m-0 text-white"><h6>今日新增客户</h6></span>
                ...
                <div class="card gradient-success o-hidden">
                  <div class="card-body b-r-4">
                    <div class="media static-top-widget">
                      ...
                      <a href="<?php echo U('communityhead/distribulist'); ?>" title="团长总提成=待结算提成+已结算提成">
                        <div class="media-body"><span class="m-0 text-white"><h6>团长总提成</h6></span>
          ...
          <div class="row m-l-0 m-r-0">
            <div class="col-sm-12 col-md-2 col-xl-2 box-col-2">
              <div class="ribbon-wrapper card p-t-0">
                ...
                <div>
                  <div class="card-header no-border" style="padding-bottom: 20px!important;"><h5 class="font-primary">
                      常用功能</h5></div>
                  <div class="card-body p-t-10 pl-10 p-b-40" style="padding-left:10px;padding-right:10px">
                      <?php if (!defined('ROLE') || ROLE != 'agenter') { if (D('Seller/Menu')->check_seller_perm('goods/index')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('goods/addgoods'); ?>">
                            <button class="btn btn-pill btn-secondary font-white f-w-700" style="padding-left:30px!important;padding-right:30px!important;font-size:18px">
                              添加商品
                            </button>
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important">
                              <i data-feather="folder-plus"></i></button>
                          </a>
                        </div>
                      <?php } if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                      ...
                      <?php } if (D('Seller/Menu')->check_seller_perm('communityhead/distribulist')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('communityhead/distribulist'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important">
                              <i data-feather="shopping-bag"></i></button>
                          </a>
                        </div>
                      <?php } if (D('Seller/Menu')->check_seller_perm('communityhead/distributionpostal')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('communityhead/distributionpostal'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important">
                              <i data-feather="download-cloud"></i></button>
                          </a>
                        </div>
                      <?php } if (D('Seller/Menu')->check_seller_perm('configindex/slider')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('configindex/slider'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important">
                              <i data-feather="monitor"></i></button>
                          </a>
                        </div>
                      <?php } if (D('Seller/Menu')->check_seller_perm('order/orderaftersales')) { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('order/orderaftersales'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important">
                              <i data-feather="thumbs-up"></i></button>
                          </a>
                        </div>
                      ...
                      <?php } } else { ?>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('goods/addgoods'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important"><i data-feather="settings"></i></button>
                          </a>
                        </div>
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('order/index'); ?>">
                        ...
                        <div class="btc-sell text-center m-b-30" style="margin-left:-40px">
                          <a href="<?php echo U('order/orderaftersales'); ?>">
                            ...
                            <button class="btn btn-pill font-secondary f-w-700" style="padding-right:20px!important"><i data-feather="thumbs-up"></i></button>
                          </a>
                        </div>
                      <?php } ?>
                  </div>
            ...
            <div class="col-sm-12 col-md-10 col-xl-10 box-col-10 row m-l-0 m-r-0 p-0">
                              ...
                              <?php if (!defined('ROLE') || ROLE != 'agenter') { if (D('Seller/Menu')->check_seller_perm('goods/index')) { ?>
                                ...
                                <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                  <div class=" align-self-center text-center" style="padding:25px 0">
                                    <h5 class="num goods_stock_notice_count f-w-700 mb-0"></h5>
                                  </div>
                                </div>
                              <?php } } ?>
                          </div>
                        ...
                        <div class="cal-date-widget card-body p-0">
                          <div class="row">
                              <?php if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                                ...
                                <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                  <div class=" align-self-center text-center" style="padding:25px 0">
                                    <h5 class="num wait_pay_order_count f-w-700 mb-0"></h5>
                                  </div>
                                </div>
                              <?php } ?>
                          </div>
                        ...
                        <div class="cal-date-widget card-body p-0">
                          <div class="row">
                              <?php if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                                ...
                                <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                  <div class=" align-self-center text-center" style="padding:25px 0">
                                    <h5 class="num wait_order_count f-w-700 mb-0"></h5>
                                  </div>
                                </div>
                              <?php } ?>
                          </div>
                            ...
                            <div class="cal-date-widget card-body p-0">
                              <div class="row">
                                  <?php if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                                    ...
                                    <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                      <div class=" align-self-center text-center" style="padding:25px 0">
                                        <h5 class="num after_sale_order_count f-w-700 mb-0"></h5>
                                      </div>
                                    </div>
                                  <?php } ?>
                              </div>
                            ...
                            <div class="cal-date-widget card-body p-0">
                              <div class="row">
                                  <?php if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                                    ...
                                    <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                      <div class=" align-self-center text-center" style="padding:25px 0">
                                        <h5 class="num  wai_comment_order_count f-w-700 mb-0"></h5>
                                      </div>
                                    </div>
                                  <?php } ?>
                              </div>
                            ...
                            <div class="cal-date-widget card-body p-0">
                              <div class="row">
                                  <?php if (D('Seller/Menu')->check_seller_perm('order/index')) { ?>
                                    ...
                                    <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                      <div class=" align-self-center text-center" style="padding:25px 0">
                                        <h5 class="num  wait_shen_order_comment_count f-w-700 mb-0"></h5>
                                      </div>
                                    </div>
                                  <?php } ?>
                              </div>
                            ...
                            <div class="cal-date-widget card-body p-0">
                              <div class="row">
                                  <?php if (D('Seller/Menu')->check_seller_perm('goods/index')) { ?>
                                    ...
                                    <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                      <div class=" align-self-center text-center" style="padding:25px 0">
                                        <h5 class="num stock_goods_count f-w-700 mb-0"></h5>
                                      </div>
                                    </div>
                                  <?php } ?>
                              </div>
                            ...
                            <div class="cal-date-widget card-body p-0">
                              <div class="row">
                                  <?php if (D('Seller/Menu')->check_seller_perm('communityhead/index')) { ?>
                                    ...
                                    <div class="col-xl-4 col-xs-4 col-md-4 col-sm-4 gradient-primary p-l-0">
                                      <div class=" align-self-center text-center" style="padding:25px 0">
                                        <h5 class="num tixian_count f-w-700 mb-0"></h5>
                                      </div>
                                    </div>
                                  <?php } ?>
                              </div>
                        ...
                        <?php if (!defined('ROLE') || ROLE != 'agenter') { ?>
                          <div class="col-sm-6 pr-0">
                            <div class="media border-after-xs p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">总数</h6>
                                <h4 class="txt-primary f-w-600 mb-0">客户</h4>
                              </div>
                          ...
                          <div class="col-sm-6 pl-0">
                            <div class="media border-after-xs p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">总计</h6>
                                <h4 class="txt-primary f-w-600 mb-0">商品数</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                          ...
                          <div class="col-sm-6 pr-0">
                            <div class="media border-after-xs p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">总计</h6>
                                <h4 class="txt-primary f-w-600 mb-0">团长数</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                          ...
                          <div class="col-sm-6 pl-0">
                            <div class="media p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">一周</h6>
                                <h4 class="txt-primary f-w-600 mb-0">订单数</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                          ...
                          <div class="col-sm-6 pr-0">
                            <div class="media border-after-xs p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">一周</h6>
                                <h4 class="txt-primary f-w-600 mb-0">销售额</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                          ...
                          <div class="col-sm-6 pl-0">
                            <div class="media p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">一周</h6>
                                <h4 class="txt-primary f-w-600 mb-0">退款额</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                        ...
                        <?php } else { ?>
                          ...
                          <div class="col-sm-6 pl-0">
                            <div class="media p-30">
                              <div class="align-self-center mr-3 text-left">
                                <h6 class="mb-1">商品</h6>
                                <h4 class="txt-primary f-w-600 mb-0">总数</h4>
                              </div>
                              <div class="media-body text-right align-self-center">
                                <h3 class="mb-0">¥<span class="num goods_count"></span></h3>
                              </div>
                    ...
                    <div class="default-datepicker">
                      <div class="datepicker-here" data-language="zh_CN">
                        <div class="datepicker-inline">
                          ...
                          <span class="default-dots-stay overview-dots full-width-dots"><span class="dots-group"><span class="dots dots1"></span><span class="dots dots2 dot-small"></span><span class="dots dots3 dot-small"></span><span
                                class="dots dots4 dot-medium"></span><span
                                class="dots dots5 dot-small"></span><span class="dots dots6 dot-small"></span><span class="dots dots7 dot-small-semi"></span><span class="dots dots8 dot-small-semi"></span><span
              ...
              <div class="col-xl-8 col-md-8 col-sm-8 box-col-8">
                <div class="card year-overview">
                  <div class="card-header no-border">
                    <h5 class="font-primary">近十日客户增长</h5>
                    <ul class="creative-dots">
                      <li class="bg-primary big-dot"></li>
                      <li class="bg-secondary semi-big-dot"></li>
                      <li class="bg-warning medium-dot"></li>
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 box-col-12">
                <div class="card year-overview">
                  <div class="card-header no-border pb-3">
                    <h5 class="font-primary">近两周交易统计</h5>
                    <ul class="creative-dots">
                      <li class="bg-primary big-dot"></li>
                      <li class="bg-secondary semi-big-dot"></li>
                      <li class="bg-warning medium-dot"></li>
                  ...
                  <div class="card-body pb-0 pt-0 pl-0 pr-3">
              ...
              <div class="col-xl-6 col-md-6 col-sm-12 box-col-6">
                <div class="card year-overview">
                  <div class="card-header no-border d-flex pb-3">
                    <h5 class="font-primary">本月商品销售排行<span class="badge badge-pill pill-badge-secondary f-14 f-w-600 num month_count"><?php echo $date_month; ?></span>
                    </h5>
                    <ul class="creative-dots">
                      <li class="bg-primary big-dot"></li>
                      <li class="bg-secondary semi-big-dot"></li>
                    ...
                    <div class="header-right pull-right text-right">
                      <h5 class="mb-2" data-value="total">销售金额：¥<span class="num month_good_count"></span></h5>
                      <h6 class="f-w-700 mb-0 default-text" data-value="total">销售数量：<span class="month_good_money"></span></h6>
                    </div>
                  </div>
              ...
              <div class="col-xl-6 col-md-6 col-sm-12 box-col-6">
                <div class="card year-overview">
                  <div class="card-header no-border d-flex pb-3">
                    ...
                    <div class="header-right pull-right text-right">
                      <h5 class="mb-2" data-value="total">销售金额：¥<span class="num month_good_count"></span></h5>
                      <h6 class="f-w-700 mb-0 default-text">(<span class="last_month"></span>)</h6>
                    </div>
                  </div>
                  <div class="card-body pb-0 pt-0">
...
<script src="/assets/js/chart/echarts/dist/echarts.js"></script>
...
<script src="/assets/js/roll/jquery.countup.min.js" type="text/javascript"></script>
<!-- Theme js-->
<script>
    layui.config({
...
<script>
    ...
    function load_echat_month_goods_sales() {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    var dom = document.getElementById("echat_month_goods_sales");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 0) {
                    ...
                    $('.last_month').html(data.data.month);
